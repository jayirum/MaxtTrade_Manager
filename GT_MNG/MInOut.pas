...
uses
  ...
  bsribbon, ExtCtrls, RzPanel, PacketStruct, UniDAC_Helper;
...
begin
  inherited;
  edAmt.Text := FormatFloat(__FORMAT_AMT, TextToFloat(edRqstAmt.Text));
end;
...
begin
  ...
  begin
    ...
    else _sMainWhere := 'IO_TP = ' + QuotedStr(rgType.Values[rgType.ItemIndex]);
