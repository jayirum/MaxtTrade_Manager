inherited fmArtc: TfmArtc
  ...
  inherited imgBtn: TImageList
    Bitmap = {
      494C01010B0034007C0010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  inherited dbMain: TUniQuery
    ...
    object dbMainTICKSIZE: TStringField
      FieldKind = fkCalculated
      FieldName = 'TICKSIZE'
      Size = 30
      Calculated = True
    end
    object dbMainTICKSIZELOW: TStringField
      FieldKind = fkCalculated
      FieldName = 'TICKSIZELOW'
      Size = 30
      Calculated = True
    end
    object dbMainCMSNTP: TStringField
      FieldKind = fkCalculated
      FieldName = 'CMSNTP'
      Size = 30
      Calculated = True
